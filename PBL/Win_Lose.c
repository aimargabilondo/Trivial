...
void Lose(SDL_Renderer* renderer, SDL_Window* window) { // Menu sin terminar SOLO FUNCIONA BOTON CERRAR 

    SDL_RenderClear(renderer);

    SDL_Texture* backgroundTexture = loadTexture(renderer, "foto/fondos/perder.bmp");
...
void Win(SDL_Renderer* renderer, SDL_Window* window) { // Menu sin terminar SOLO FUNCIONA BOTON CERRAR 

    SDL_RenderClear(renderer);

    SDL_Texture* backgroundTexture = loadTexture(renderer, "foto/fondos/ganar.bmp");
